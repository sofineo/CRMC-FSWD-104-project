...
label_hours = tk.Label(root, text = "Hours",
    font=('Arial', 11), borderwidth=1, relief=RAISED,padx=10, pady=5, width=17, bg= '#76EDF8')
...
label_07am_08am = tk.Label(root, text = "07 am - 08 am",
    font=('Arial', 11), borderwidth=1, relief=RAISED,padx=10, pady=5, width=17, bg = "#0F73E5")
label_08am_09am = tk.Label(root, text = "08 am - 09 am",
    font=('Arial', 11), borderwidth=1, relief=RAISED,padx=10, pady=5, width=17, bg = "#16C14D", fg = "white")
...
##------------------
def on_motion(event):
    label_monday_09am.config(text='Class101-IST04')
    
def on_leave0(event):
    label_monday_09am.config(text='')
#--------------
def on_click(event):
    label_monday_08pm.config(text='Class201-IST03')
def on_leave(event):
    label_monday_08pm.config(text='')  
#Monday labels
...
label_monday_09pm = tk.Label(root, text = "--",
    font=('Arial', 11), borderwidth=1, relief=RAISED,padx=10, pady=5, width=17, bg = "white")   
#-------------
label_monday_09am.bind('<Motion>', on_motion)
label_monday_09am.bind('<Leave>', on_leave0)
#-------------
label_monday_08pm.bind('<Button-1>', on_click)
label_monday_08pm.bind('<Leave>', on_leave)
#----------------
